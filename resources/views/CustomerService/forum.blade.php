...
@section('content')
                    ...
                    <tr>
                        <div class="card p-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>
                                    <form action="{{ route('addreplyforumcs', $thread->id) }}" method="POST">
                                        @csrf
                                        <h3>Posts</h3>
                                        @php
                                    ...
                                    @if ($thread->namamember=="Customer Service")
                                ...
                                @endif
                                    ...
                                    @foreach ($comments as $comment)
                                        ...
                                        <form action="{{ route('addreplycommentforumcs', $comment->id) }}" method="POST">
                                            @csrf
                                            <br>
                                            <span>
                                                @php
    ...
    <form class="form-horizontal" action="{{ route('addpostforumcs', $idkategori) }}" method="POST">
        @csrf
        <h1>Post</h1>
        ...
        <br>
        <br>
        <a href="/cs/forum"><button type="button" class="btn btn-danger">Back To Dashboard</button></a>
