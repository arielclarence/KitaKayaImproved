...
<div class="mb-2">
    ...
    <div class="row">
        ...
        <div class="col-3 text-end">
            <a href="{{ url('/cs/forum') }}" class="btn btn-danger">Back To Forums</a>
        </div>
    </div>
</div>
<hr>
...
<div class="d-flex flex-wrap justify-content-evenly">
    ...
    <a href="{{ url("/cs/forum/$thread->id/detail") }}" class="text-decoration-none text-black mb-4" style="width: 45%;">
